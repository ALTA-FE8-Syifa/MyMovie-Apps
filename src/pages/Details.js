...
const Details = () => {
  ...
  return (
    <div>
         ...
         <img src={imageUrl + location.state.backdrop_path} className="img-fluid "/>
           <div className = "row d-flex justify-content-center" style={{ paddingTop: '4rem', paddingBottom:'5rem'}} >
           <div className = "col-xl-4 col-md-6 col-8"> 
               <img src ={imageUrl+ location.state.image} className="rounded mx-auto d-block shadow image-detail" style={{ width: '18rem'}}/>
           </div>
